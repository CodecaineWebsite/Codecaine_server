...
ALTER TABLE "ai_chats" ADD CONSTRAINT "ai_chats_pen_id_pens_id_fk" FOREIGN KEY ("pen_id") REFERENCES "public"."pens"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
