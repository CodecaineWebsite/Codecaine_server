<template>
	<!--路徑的名字profile/cains/shwocase-->
	<!--profile未來會帶入使用者的名字 類似:id/cains/shwocase -->
	<div>
		<div class="pt-4">
			...
			<div class="mx-auto max-w-7xl">
				<div class="text-gray-400 border-b-6">
					<button class="cursor-pointer hover:text-white p-2" @click="Cains">
						Cains
					</button>
					<button
