    ...
    >
      ...
      >
        ...
        <nav v-if="authStore.idToken">
          ...
          <div class="mt-1.5">
            <div class="text-xl p-3 px-4 cursor-pointer btn" @click="Yourwork">
              Your Work
            </div>
          </div>
          <div class="mt-1.5">
            <div class="text-xl p-3 px-4 cursor-pointer btn" @click="Following">
              Following
            </div>
            <div class="text-xl p-3 px-4 cursor-pointer btn" @click="Trending">
              Trending
            </div>
          </div>
        </nav>
        <nav v-if="!authStore.idToken">
          ...
          <div class="mt-1.5">
            <div class="text-xl p-3 px-4 cursor-pointer btn" @click="Search">
              Search Pains
            </div>
          </div>
          <div class="mt-1.5">
